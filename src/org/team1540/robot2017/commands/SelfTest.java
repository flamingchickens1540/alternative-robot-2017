...
public class SelfTest extends CommandGroup {
    ...
    public SelfTest() {
        ...
        addSequential(new SelfTestOutputEncoderCurrent(this, "Shooter Right", () -> Robot.shooter.setRight(0.7),
                () -> Robot.shooter.setRight(0.0), () -> Robot.shooter.getFlywheelEncoder(),
                () -> Robot.shooter.getRightCurrent(), Robot.shooter), 0.5);
