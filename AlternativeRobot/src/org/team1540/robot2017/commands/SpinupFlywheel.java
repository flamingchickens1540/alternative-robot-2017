...
public class SpinupFlywheel extends Command {
    ...
    protected void initialize() {
        Robot.shooter.setSpeed(Robot.tuning.tuning.getDouble(networkTableName, defaultValue) 
    ...
    protected boolean isFinished() {
        return Robot.shooter.upToSpeed(Robot.tuning.tuning.getDouble(networkTableName, defaultValue));
    }
